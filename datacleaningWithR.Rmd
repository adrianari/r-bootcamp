...
plot(UNIDIR ~ air_temperature, data = join_zaehlung_wetter,
     ...
     col = "darkblue",
     cex = 0.5, 
     main = "Does temperature make a difference to the count of bikers and pedestrians?",
...
library(ggplot2)
par(mfrow = c(2, 2))
qplot(y = UNIDIR, x = air_temperature, data = join_zaehlung_wetter, facets = ~ TAGESZEIT, col = TAGESZEIT)
qplot(y = UNIDIR, x = air_temperature, data = join_zaehlung_wetter, facets = ~ FK_ZAEHLER, col = FK_ZAEHLER)
```
