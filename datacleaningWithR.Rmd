...
```{r}
#read in data
zaehlung_alles <- read.csv("2019_verkehrszaehlungen_werte_fussgaenger_velo_bereinigt.csv", sep=";", header = TRUE)
colnames(zaehlung_alles)[1] <- "FK_ZAEHLER"
zaehlung <- subset(zaehlung_alles, FK_ZAEHLER)
?dplyr::filter
