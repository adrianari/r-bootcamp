...
join_zaehlung_wetter %>%
  arrange(UNIDIR) %>%
  mutate(month = factor(month, levels=c("Januar", "Februar", "März", "April", "Mai", "Juni", "Juli", "August", "September", "Oktober",       "November", "Dezember"))) %>%
...
very reliant on the quality of the data. (We do not know exactly how the counting stations worked --> ). Correction factors for the analysed time span is not available yet. 